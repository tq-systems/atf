...
#pragma weak plat_scmi_sensor_count
#pragma weak plat_scmi_sensor_max_requests
#pragma weak plat_scmi_sensor_reg
#pragma weak plat_scmi_sensor_reading_get
#pragma weak plat_scmi_sensor_description_get
#pragma weak plat_scmi_sensor_update_interval
#pragma weak plat_scmi_sensor_state
#pragma weak plat_scmi_sensor_timestamped
...
uint32_t plat_scmi_sensor_reg(unsigned int agent_id __unused, unsigned int *addr)
{
	return 0U;
}
...
uint32_t plat_scmi_sensor_update_interval(uint32_t agent_id __unused, uint16_t sensor_id __unused)
{
	return 0U;
}
...
uint32_t plat_scmi_sensor_timestamped(uint32_t agent_id __unused, uint16_t sensor_id __unused)
{
	return 0U;
}
...
static void scmi_sensor_description_get(struct scmi_msg *msg)
{
	...
	struct scmi_sensor_descrition_get_p2a return_values = {
		.status = SCMI_SUCCESS,
	};
	unsigned int desc_index = 0U;
	unsigned int num_sensor_flags, num_ret;
	...
	num_sensor_flags = plat_scmi_sensor_description_get(msg->agent_id, desc_index, &return_values.desc[0]);
